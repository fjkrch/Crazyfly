...
## Complete revision-4 graph gallery

These are all eight figures generated by the completed 60-cell main run. Error
bars summarize three training seeds; they are descriptive and are not
confidence intervals or significance tests.

### Held-out score by condition
...
### Paired wind degradation

![Per-seed paired wind-minus-still score delta](runs/crazyflie_command_all_fair_seeds0_1_2_1m/command_v4_wind_delta.png)

### Training reward

![PPO training reward curves](runs/crazyflie_command_all_fair_seeds0_1_2_1m/command_v4_training_reward.png)

### Training loss

![PPO training loss curves](runs/crazyflie_command_all_fair_seeds0_1_2_1m/command_v4_training_loss.png)

### Neural or hidden-unit activity
...
![Action-producing inference latency](runs/crazyflie_command_all_fair_seeds0_1_2_1m/command_v4_inference_latency.png)

### Parameter-normalized score

![Descriptive held-out score per one thousand actor parameters](runs/crazyflie_command_all_fair_seeds0_1_2_1m/command_v4_efficiency.png)

### Peak RAM and VRAM

![Measured training and evaluation peak memory](runs/crazyflie_command_all_fair_seeds0_1_2_1m/command_v4_peak_memory.png)
